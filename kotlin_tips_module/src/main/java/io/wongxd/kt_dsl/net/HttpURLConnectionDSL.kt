...
object BaseHttpUrlConnectionHelper {
    ...
    internal class BaseHttpUrlConnectionHelperLooper private constructor(looper: Looper) : Handler(looper) {
    ...
    private fun packOneFile(
        ...
        while (dataInputStream.read(buffer).also { count = it } != -1) {
            ...
            BaseHttpUrlConnectionHelper.BaseHttpUrlConnectionHelperLooper.runOnUiThread {
                //d1.toInt() 的值为1-100
