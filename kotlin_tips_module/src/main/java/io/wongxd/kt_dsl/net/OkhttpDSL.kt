package io.wongxd.kt_dsl.net


import android.os.Handler
import android.os.Looper
import android.text.TextUtils
import io.wongxd.kotlin_tips.EasyToast
import io.wongxd.kotlin_tips.MD5
import io.wongxd.kotlin_tips.bothNotNull
import okhttp3.*
            ...
            try {
                ...
                source?.let { _ ->
                    ...
                    while ((source.read(sink.buffer(), SEGMENT_SIZE.toLong())).also { read = it } != -1L) {
                        ...
                        BaseOkHttpHelper.BaseOkHttpHelperLooper.runOnUiThread {
        ...
        http.newCall(req!!).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call?, response: Response?) {
                if (isDownload) {
                    ...
                    BaseOkHttpHelper.BaseOkHttpHelperLooper.runOnUiThread { wrap._finish.invoke() }
                    response?.let {
