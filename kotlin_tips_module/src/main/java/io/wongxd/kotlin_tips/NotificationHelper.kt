...
class NotificationHelper private constructor(private val mContext: Context) {
    ...
    companion object {
        ...
        fun getDefault(ctx: Context): NotificationHelper = NotificationHelper(ctx)
    }
    ...
    * */
    ...
    private val mNotifyManager: NotificationManager by lazy { mContext.getSystemService(Context.NOTIFICATION_SERVICE) as NotificationManager }
    ...
    fun sendNotification(
        ...
        val builder: NotificationCompat.Builder = NotificationCompat.Builder(mContext, channelTag)
    ...
    fun cancelNotification(notificationInstanceBean: NotificationInstanceBean) {
        mNotifyManager.cancel(notificationInstanceBean.channelTag, notificationInstanceBean.channelId)
    }
